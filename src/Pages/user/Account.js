...
import UserProfile from '../../components/pageComponent/UserProfile.js';
...
class Account extends Component {
  constructor(props) {
    ...
    if (props.params.id === null || props.params.id === undefined)
      ...
      this.state = { user: null, accountOwner: false };
      HttpRequest(
        ...
        this.setState({ user: response.data, fetchedAccount: false });
        HttpRequest(
          MyConfig.apiUrl + `get-rhendor-detail?email=${response.data.email}`,
          'get',
          null,
          ProcessHttpMessage
        ).then((response) => {
          this.setState({ user: response.data, fetchedAccount: true });
        });
      });
    }
  }
  ...
  render() {
    ...
    return (
      <>
        <DashboardLayout>
          {user &&
            (user.user_type === 'rhenda' ? (
              <>
                <div id="AccountCard">
                  <UserJobDescription user={user} />
                </div>
                <div className="p-3 sm:p-8 white-gray-bg shadow w-full mt-5">
                  <div className>
                    <h2 className="font-bold leading-9 gray-text m-0">
                      Contact
                    </h2>
                  </div>
                  <hr className="border-gray-300 border-opacity-50 my-5" />
                  <div className="inline-flex flex-col space-y-3.5 items-start justify-start ">
                    <div className="inline-flex space-x-3.5 items-center justify-center">
                      <svg
                        width={22}
                        height={22}
                        viewBox="0 0 22 22"
                      ...
                      <p className="text-base leading-loose">
                        {user.business_detail &&
                          user.business_detail.business_address}
                      </p>
                    </div>
                    <div className="inline-flex space-x-3.5 items-center justify-center">
                      <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                      >
                        <g clipPath="url(#clip0_2783_4161)">
                          <path
                      ...
                      <p className="text-base leading-loose">{user.whatsapp}</p>
                    </div>
                    <div className="inline-flex space-x-3.5 items-center justify-center">
                      <svg
                        width={22}
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                      >
                        <g clipPath="url(#clip0_2783_4166)">
                          <path
                      ...
                      <p className="text-base leading-loose">{user.twitter}</p>
                    </div>
                    <div className="inline-flex space-x-3.5 items-center justify-center">
                      <svg
                        width={22}
                    ...
                    <div className="inline-flex space-x-3.5 items-center justify-center">
                      ...
                      <p className="text-base leading-loose">{user.facebook}</p>
                    </div>
                  </div>
                </div>
                <div id="jobs">
              ...
              <UserProfile user={user} accountOwner={this.state.accountOwner} />
            ))}
        </DashboardLayout>
      </>
    );
