...
export default function PostCard(props) {
  ...
  likesPost = checkIfLiked(post, loggedInUser, likesPost);

  // set state for likedPost
  const [likedPost, setLikedPost] = useState(likesPost);
          ...
          <div className="flex justify-between">
            <NavLink to={`/account/${post.user.id}`}>
              <Avatar
                ...
                name={post.user.name}
                nameClass="font-bold"
                description={dayjs(post.updated_at).format(
                  "ddd, DD MMM, h:mm a"
                )}
...
export function UserPostCard(props) {
  ...
  return (
    <>
      <div
        id={elementId}
        className="flex sm:space-x-6 p-2 md:p-8 shadow rounded"
      >
        <img
        ...
        <div className="inline-flex flex-col space-y-1 sm:space-y-4 justify-end bg-white rounded-lg grow border-b rounded-none">
          <div className="flex justify-between items-start">
            <div className="flex space-x-2 sm:space-x-0">
              ...
              <div className="inline-flex flex-col space-y-2 items-start justify-start">
                <p className="text-xs sm:text-lg font-bold leading-normal text-gray-900">
                  {postOwner.name}
                </p>
          ...
          <p className="text-xs sm:text-base leading-snug text-black text-opacity-50">
            {post.body}
          </p>
          ...
          {post.has_images === "1" && (
            <div className="lg:pb-5 flex">
              <div className="lg:pb-5 flex">
                {post.images?.map((img) => (
                  <div>
                    <img src={img.image} alt="post image" className="w-full" />
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="inline-flex items-center justify-between py-2 border-black border-opacity-40 w-full">
            <div className="flex space-x-1 sm:space-x-5 items-center justify-center">
              <div className="flex items-start justify-start">
                <img
                  className="w-3 sm:w-5 lg:w-8 h-full rounded-full"
              ...
              <p className="text-2xs sm:text-xs lg:text-base text-gray-900">
                +200 Likes
              </p>
            </div>
            <div className="flex space-x-2 sm:space-x-4 items-center justify-center">
              <div className="flex space-x-1 sm:space-x-2 items-center justify-center cursor-pointer">
                ...
                >
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M1.67157 1.17157C3.23366 -0.390524 5.76631 -0.390524 7.32841 1.17157L8.49998 2.34315L9.67155 1.17157C11.2336 -0.390524 13.7663 -0.390524 15.3284 1.17157C16.8905 2.73367 16.8905 5.26633 15.3284 6.82843L8.49998 13.6569L1.67157 6.82843C0.109477 5.26633 0.109477 2.73367 1.67157 1.17157Z"
                    fill="#C5A2F0"
                  />
                </svg>
                <p className="text-2xs sm:text-xs lg:text-base leading-snug text-gray-900">
                  Like
                </p>
              </div>
              <div className="flex space-x-1 sm:space-x-2 items-center justify-center cursor-pointer">
                ...
                >
                  <path
                    d="M6.5 7H6.51M10.5 7H10.51M14.5 7H14.51M7.5 13H3.5C2.39543 13 1.5 12.1046 1.5 11V3C1.5 1.89543 2.39543 1 3.5 1H17.5C18.6046 1 19.5 1.89543 19.5 3V11C19.5 12.1046 18.6046 13 17.5 13H12.5L7.5 18V13Z"
                    stroke="#666666"
                    strokeWidth={2}
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <div className="flex space-x-1 sm:space-x-2 items-center justify-center cursor-pointer">
                ...
                >
                  <path
                    d="M13.5 6C15.1569 6 16.5 4.65685 16.5 3C16.5 1.34315 15.1569 0 13.5 0C11.8431 0 10.5 1.34315 10.5 3C10.5 3.12548 10.5077 3.24917 10.5227 3.37061L5.58259 5.84064C5.04303 5.32015 4.3089 5 3.5 5C1.84315 5 0.5 6.34315 0.5 8C0.5 9.65685 1.84315 11 3.5 11C4.30892 11 5.04306 10.6798 5.58263 10.1593L10.5227 12.6293C10.5077 12.7508 10.5 12.8745 10.5 13C10.5 14.6569 11.8431 16 13.5 16C15.1569 16 16.5 14.6569 16.5 13C16.5 11.3431 15.1569 10 13.5 10C12.6911 10 11.957 10.3201 11.4174 10.8406L6.47733 8.37061C6.49229 8.24917 6.5 8.12548 6.5 8C6.5 7.8745 6.49229 7.7508 6.47733 7.62934L11.4174 5.15932C11.9569 5.67984 12.6911 6 13.5 6Z"
                    fill="#666666"
                  />
                </svg>
                <RWebShare
                  data={{
                    text: `${postOwner.name}'s post`,
                    text: `post`,
